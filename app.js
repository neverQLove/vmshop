...
App({
    ...
    getUserInfo: function(t, i, n) {
        ...
        wx.login({
            success: function(n) {
                console.log("wx.login=" + JSON.stringify(n)), n.code ? e.post("wxapp/login", {
                    code: n.code
                }, function(n) {
    ...
    impower: function(e, t, i) {
     ...
     globalData: {
        appid: "wx7afdbb535246abd1",
        api: "https://weixin.weimaishop.com/app/ewei_shopv2_api.php?i=40",
        approot: "https://weixin.weimaishop.com/addons/ewei_shopv2/",        
        userInfo: null
    }
});