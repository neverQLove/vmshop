...
Page((e = {
    ...
    onLoad: function(t) {
        ...
        }, 3e3), i.url(t), n.get(this, t.pageid, function(t) {
...
t(e, "onShareAppMessage", function() {
    ...
    console.error(t);
    var a = this, e = a.data.diypages, i = e.items, o = t.currentTarget.dataset.id, n = t.currentTarget.dataset.url, r = t.currentTarget.dataset.type;
