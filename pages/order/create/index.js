...
Page({
    ...
    number: function(t) {
        var e = this, r = a.pdata(t), d = i.number(this, t), o = r.id, c = e.data.list, n = 0, l = 0;
    ...
    caculate: function(t) {
        ...
        e.data.data && 0 != e.data.data.couponid && (i = e.data.data.couponid), a.post("order/create/caculate", {
            ...
            t.deductcredit2 = a.deductcredit2, e.data.data.deduct && (a.realprice -= a.deductcredit), 
    ...
    submit: function() {
        ...
        console.log(t.fromquick), !t.submit && r.verify(this, i)) {
            ...
            if (t.list.storeInfo && (o.carrierid = t.list.storeInfo.id), 1 == t.data.dispatchtype || t.list.isvirtual || t.list.isverify) {
                if ("" == s.trim(t.list.member.realname)) return void a.alert("请填写联系人!");
